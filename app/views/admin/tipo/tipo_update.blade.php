...
<div class="container">
    <div class="col-md-8">
        ...
        @endif
        <h3>Ingrese el Tipo</h3><br>
        {{ Form::open(array('route' => array('admin_tipo_update_post', $tipo->id))) }}
            <div class="row">
                <div class="col-md-2 col-xs-3 col-sm-2"><label class="control-label"> Nombre:</label></div>
                <div class="col-md-10 col-xs-15 col-sm-10">{{ Form::text('nombre', $tipo->nombre, ['class' => 'form-control']) }}</div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-10 col-xs-15 col-sm-10">
                    {{ Form::checkbox('status', 1, $tipo->valor($tipo->id), ['class' => 'form-control']) }}
                </div>
            </div><br>
            <div class="form-actions" align="center">
                <button type="submit" class="btn btn-lg btn-primary">
                    <i class="glyphicon glyphicon-floppy-saved"></i> Confirmar</button>
                <a href="{{ URL::route('admin_tipos') }}" class="btn btn-lg btn-danger">
