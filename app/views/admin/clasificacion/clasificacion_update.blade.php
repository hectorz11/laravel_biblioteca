...
<div class="container">
    <div class="col-md-8">
        ...
        @endif
        <h3>Ingrese la Clasificacion</h3><br>
        {{ Form::open(array('route' => array('admin_clasificacion_update_post', $clasificacion->id))) }}
            <div class="row">
                ...
                <div class="col-md-10 col-xs-15 col-sm-10">
                    {{ Form::text('nombre', $clasificacion->nombre, ['class' => 'form-control']) }}
                </div>
            </div>
            ...
            <div class="form-actions" align="center">
                ...
                <a href="{{ URL::route('admin_clasificaciones') }}" class="btn btn-lg btn-danger">
